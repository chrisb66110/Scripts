...
namespace Catalogue.Api.Test.ControllersTest.ImageControllerTest
{
    ...
    [TestClass]
    public class GetByIdAsyncTest : BaseTest<ImageController>
    {
        [TestMethod]
        public async Task GetByIdAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<IImageBll, string, ImageDto>(autoMock, m => m.GetByIdAsync(It.IsAny<string>()), responseBll, param =>
                {
        ...
        public async Task GetByIdAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IImageBll, ImageDto>(autoMock, m => m.GetByIdAsync(It.IsAny<string>()), exception);
