...
namespace Catalogue.Api.Test.ControllersTest.ProductSizeControllerTest
{
    ...
    [TestClass]
    public class GetByIdAsyncTest : BaseTest<ProductSizeController>
    {
        [TestMethod]
        public async Task GetByIdAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<IProductSizeBll, string, ProductSizeDto>(autoMock, m => m.GetByIdAsync(It.IsAny<string>()), responseBll, param =>
                {
        ...
        public async Task GetByIdAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IProductSizeBll, ProductSizeDto>(autoMock, m => m.GetByIdAsync(It.IsAny<string>()), exception);
