...
namespace Catalogue.Api.Test.ControllersTest.SizeControllerTest
{
    [ExcludeFromCodeCoverage]
    [TestClass]
    public class GetAllAsyncTest : BaseTest<SizeController>
    {
        [TestMethod]
        public async Task GetAllAsyncHappyPath()
        {
            ...
            {
                var responseBll = DataTestHelper.GivenTheDefaultListSizeDto();
                AndIMockDependencyMethod<ISizeBll, List<SizeDto>>(autoMock, m => m.GetAllAsync(), responseBll);
                ...
                var responseObject = (List<SizeResponse>) response.Value;
        ...
        public async Task GetAllAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<ISizeBll, List<SizeDto>>(autoMock, m => m.GetAllAsync(), exception);
