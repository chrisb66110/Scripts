...
namespace Catalogue.Api.Test.ControllersTest.SizeControllerTest
{
    ...
    [TestClass]
    public class DeleteAsyncTest : BaseTest<SizeController>
    {
        [TestMethod]
        public async Task DeleteAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<ISizeBll, SizeDto, SizeDto>(autoMock, m => m.DeleteAsync(It.IsAny<SizeDto>()), responseBll, param =>
                {
        ...
        public async Task DeleteAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<ISizeBll, SizeDto>(autoMock, m => m.DeleteAsync(It.IsAny<SizeDto>()), exception);
