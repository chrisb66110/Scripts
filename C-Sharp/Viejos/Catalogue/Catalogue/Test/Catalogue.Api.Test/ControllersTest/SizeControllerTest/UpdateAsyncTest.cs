...
namespace Catalogue.Api.Test.ControllersTest.SizeControllerTest
{
    ...
    [TestClass]
    public class UpdateAsyncTest : BaseTest<SizeController>
    {
        [TestMethod]
        public async Task UpdateAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<ISizeBll, SizeDto, SizeDto>(autoMock, m => m.UpdateAsync(It.IsAny<SizeDto>()), responseBll, param =>
                {
        ...
        public async Task UpdateAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<ISizeBll, SizeDto>(autoMock, m => m.UpdateAsync(It.IsAny<SizeDto>()), exception);
