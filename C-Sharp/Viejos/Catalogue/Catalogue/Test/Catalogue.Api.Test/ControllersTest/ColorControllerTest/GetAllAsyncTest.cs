...
namespace Catalogue.Api.Test.ControllersTest.ColorControllerTest
{
    ...
    [TestClass]
    public class GetAllAsyncTest : BaseTest<ColorController>
    {
        [TestMethod]
        public async Task GetAllAsyncHappyPath()
        {
            ...
            {
                var responseBll = DataTestHelper.GivenTheDefaultListColorDto();
                AndIMockDependencyMethod<IColorBll, List<ColorDto>>(autoMock, m => m.GetAllAsync(), responseBll);
                ...
                var responseObject = (List<ColorResponse>) response.Value;
        ...
        public async Task GetAllAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IColorBll, List<ColorDto>>(autoMock, m => m.GetAllAsync(), exception);
