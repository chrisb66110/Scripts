...
{
    public class GenderRepository : BaseRepository<Gender, string>, IGenderRepository
    {
        private readonly IMapper _mapper;

        public GenderRepository(CatalogueContext context, IMapper mapper) : base(context)
        {
            _mapper = mapper;
        }
        ...
        public async Task<GenderDto> GetByIdAsync(string id)
        {
