...
namespace DeployBothSystem.Bll.Test.BllsTest.BothBllTest
{
    ...
    [TestClass]
    public class DeleteAsyncTest : BaseTest<BothBll>
    {
        [TestMethod]
        public async Task DeleteAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IBothRepository, BothDto, BothDto>(autoMock, m => m.DeleteAsync(It.IsAny<BothDto>()), responseRepository, param =>
                {
        ...
        public async Task DeleteAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IBothRepository, BothDto>(autoMock, m => m.DeleteAsync(It.IsAny<BothDto>()), responseRepository);
