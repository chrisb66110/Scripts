...
namespace DeployBothSystem.Api.Test.ControllersTest.BothControllerTest
{
    ...
    [TestClass]
    public class UpdateAsyncTest : BaseTest<BothController>
    {
        [TestMethod]
        public async Task UpdateAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<IBothBll, BothDto, BothDto>(autoMock, m => m.UpdateAsync(It.IsAny<BothDto>()), responseBll, param =>
                {
        ...
        public async Task UpdateAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<IBothBll, BothDto>(autoMock, m => m.UpdateAsync(It.IsAny<BothDto>()), exception);
