...
namespace Catalogue2.Api.Test.ControllersTest.ProductColorControllerTest
{
    ...
    [TestClass]
    public class AddAsyncTest : BaseTest<ProductColorController>
    {
        [TestMethod]
        public async Task AddAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<IProductColorBll, ProductColorDto, ProductColorDto>(autoMock, m => m.AddAsync(It.IsAny<ProductColorDto>()), responseBll, param =>
                {
        ...
        public async Task AddAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<IProductColorBll, ProductColorDto>(autoMock, m => m.AddAsync(It.IsAny<ProductColorDto>()), exception);
