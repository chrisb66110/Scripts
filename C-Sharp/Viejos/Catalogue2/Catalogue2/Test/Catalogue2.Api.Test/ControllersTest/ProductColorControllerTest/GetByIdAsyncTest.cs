...
namespace Catalogue2.Api.Test.ControllersTest.ProductColorControllerTest
{
    ...
    [TestClass]
    public class GetByIdAsyncTest : BaseTest<ProductColorController>
    {
        [TestMethod]
        public async Task GetByIdAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<IProductColorBll, string, ProductColorDto>(autoMock, m => m.GetByIdAsync(It.IsAny<string>()), responseBll, param =>
                {
        ...
        public async Task GetByIdAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IProductColorBll, ProductColorDto>(autoMock, m => m.GetByIdAsync(It.IsAny<string>()), exception);
