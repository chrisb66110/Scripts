...
namespace Catalogue2.Api.Test.ControllersTest.ProductColorControllerTest
{
    ...
    [TestClass]
    public class UpdateAsyncTest : BaseTest<ProductColorController>
    {
        [TestMethod]
        public async Task UpdateAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<IProductColorBll, ProductColorDto, ProductColorDto>(autoMock, m => m.UpdateAsync(It.IsAny<ProductColorDto>()), responseBll, param =>
                {
        ...
        public async Task UpdateAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<IProductColorBll, ProductColorDto>(autoMock, m => m.UpdateAsync(It.IsAny<ProductColorDto>()), exception);
