...
namespace Catalogue2.Api.Test.ControllersTest.AgeGroupControllerTest
{
    ...
    [TestClass]
    public class DeleteAsyncTest : BaseTest<AgeGroupController>
    {
        [TestMethod]
        public async Task DeleteAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<IAgeGroupBll, AgeGroupDto, AgeGroupDto>(autoMock, m => m.DeleteAsync(It.IsAny<AgeGroupDto>()), responseBll, param =>
                {
        ...
        public async Task DeleteAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<IAgeGroupBll, AgeGroupDto>(autoMock, m => m.DeleteAsync(It.IsAny<AgeGroupDto>()), exception);
