...
namespace Catalogue2.Api.Test.ControllersTest.AgeGroupControllerTest
{
    [ExcludeFromCodeCoverage]
    [TestClass]
    public class GetAllAsyncTest : BaseTest<AgeGroupController>
    {
        [TestMethod]
        public async Task GetAllAsyncHappyPath()
        {
            ...
            {
                var responseBll = DataTestHelper.GivenTheDefaultListAgeGroupDto();
                AndIMockDependencyMethod<IAgeGroupBll, List<AgeGroupDto>>(autoMock, m => m.GetAllAsync(), responseBll);
                ...
                var responseObject = (List<AgeGroupResponse>) response.Value;
        ...
        public async Task GetAllAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IAgeGroupBll, List<AgeGroupDto>>(autoMock, m => m.GetAllAsync(), exception);
