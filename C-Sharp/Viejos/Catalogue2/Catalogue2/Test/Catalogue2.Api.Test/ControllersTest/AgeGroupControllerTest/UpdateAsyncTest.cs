...
namespace Catalogue2.Api.Test.ControllersTest.AgeGroupControllerTest
{
    ...
    [TestClass]
    public class UpdateAsyncTest : BaseTest<AgeGroupController>
    {
        [TestMethod]
        public async Task UpdateAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<IAgeGroupBll, AgeGroupDto, AgeGroupDto>(autoMock, m => m.UpdateAsync(It.IsAny<AgeGroupDto>()), responseBll, param =>
                {
        ...
        public async Task UpdateAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<IAgeGroupBll, AgeGroupDto>(autoMock, m => m.UpdateAsync(It.IsAny<AgeGroupDto>()), exception);
