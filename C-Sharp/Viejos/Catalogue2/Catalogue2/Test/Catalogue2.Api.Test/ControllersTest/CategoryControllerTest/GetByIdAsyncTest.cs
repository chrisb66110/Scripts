...
namespace Catalogue2.Api.Test.ControllersTest.CategoryControllerTest
{
    ...
    [TestClass]
    public class GetByIdAsyncTest : BaseTest<CategoryController>
    {
        [TestMethod]
        public async Task GetByIdAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<ICategoryBll, string, CategoryDto>(autoMock, m => m.GetByIdAsync(It.IsAny<string>()), responseBll, param =>
                {
        ...
        public async Task GetByIdAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<ICategoryBll, CategoryDto>(autoMock, m => m.GetByIdAsync(It.IsAny<string>()), exception);
