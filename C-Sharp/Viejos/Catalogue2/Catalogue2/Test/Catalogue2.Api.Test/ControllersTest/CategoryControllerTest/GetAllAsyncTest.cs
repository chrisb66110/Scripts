...
namespace Catalogue2.Api.Test.ControllersTest.CategoryControllerTest
{
    [ExcludeFromCodeCoverage]
    [TestClass]
    public class GetAllAsyncTest : BaseTest<CategoryController>
    {
        [TestMethod]
        public async Task GetAllAsyncHappyPath()
        {
            ...
            {
                var responseBll = DataTestHelper.GivenTheDefaultListCategoryDto();
                AndIMockDependencyMethod<ICategoryBll, List<CategoryDto>>(autoMock, m => m.GetAllAsync(), responseBll);
                ...
                var responseObject = (List<CategoryResponse>) response.Value;
        ...
        public async Task GetAllAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<ICategoryBll, List<CategoryDto>>(autoMock, m => m.GetAllAsync(), exception);
