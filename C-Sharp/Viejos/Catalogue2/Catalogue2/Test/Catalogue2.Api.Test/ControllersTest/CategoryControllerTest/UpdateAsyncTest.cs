...
namespace Catalogue2.Api.Test.ControllersTest.CategoryControllerTest
{
    ...
    [TestClass]
    public class UpdateAsyncTest : BaseTest<CategoryController>
    {
        [TestMethod]
        public async Task UpdateAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<ICategoryBll, CategoryDto, CategoryDto>(autoMock, m => m.UpdateAsync(It.IsAny<CategoryDto>()), responseBll, param =>
                {
        ...
        public async Task UpdateAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<ICategoryBll, CategoryDto>(autoMock, m => m.UpdateAsync(It.IsAny<CategoryDto>()), exception);
