...
namespace Catalogue2.Api.Test.ControllersTest.CategoryControllerTest
{
    ...
    [TestClass]
    public class DeleteAsyncTest : BaseTest<CategoryController>
    {
        [TestMethod]
        public async Task DeleteAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<ICategoryBll, CategoryDto, CategoryDto>(autoMock, m => m.DeleteAsync(It.IsAny<CategoryDto>()), responseBll, param =>
                {
        ...
        public async Task DeleteAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<ICategoryBll, CategoryDto>(autoMock, m => m.DeleteAsync(It.IsAny<CategoryDto>()), exception);
