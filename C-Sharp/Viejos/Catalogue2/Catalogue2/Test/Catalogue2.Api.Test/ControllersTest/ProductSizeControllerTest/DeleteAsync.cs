...
namespace Catalogue2.Api.Test.ControllersTest.ProductSizeControllerTest
{
    ...
    [TestClass]
    public class DeleteAsyncTest : BaseTest<ProductSizeController>
    {
        [TestMethod]
        public async Task DeleteAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<IProductSizeBll, ProductSizeDto, ProductSizeDto>(autoMock, m => m.DeleteAsync(It.IsAny<ProductSizeDto>()), responseBll, param =>
                {
        ...
        public async Task DeleteAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<IProductSizeBll, ProductSizeDto>(autoMock, m => m.DeleteAsync(It.IsAny<ProductSizeDto>()), exception);
