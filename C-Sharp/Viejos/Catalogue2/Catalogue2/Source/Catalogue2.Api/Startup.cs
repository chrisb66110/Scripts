...
namespace Catalogue2.Api
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connectionString = Configuration.GetConnectionString("Catalogue2ConnectionString");
            services.AddDbContextPool<Catalogue2Context>(options =>
            {
            ...
            services.Configure<Catalogue2Settings>(Configuration);
            ...
            services.ConfigureAuthentication<Catalogue2Settings>(container, "tempkey.rsa");
            
            //Configure Cors allowed
            services.ConfigureCors<Catalogue2Settings>(container, "GET", "POST", "PUT");
        ...
        public void AddAutoFacRegistration(ContainerBuilder builder)
        {
            ...
            {
                var connectionString = ctx.Resolve<Catalogue2Settings>().ConnectionStrings.Catalogue2ConnectionString;
                var dbOptions = new DbContextOptionsBuilder<Catalogue2Context>().UseNpgsql(connectionString).Options;
                return new Catalogue2Context(dbOptions);
            ...
            builder.Register(ctx =>
            {
                var options = ctx.Resolve<IOptions<Catalogue2Settings>>();
