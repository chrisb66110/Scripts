...
namespace Catalogue.Api.Test.ControllersTest.ProductSizeControllerTest
{
    [ExcludeFromCodeCoverage]
    [TestClass]
    public class UpdateAsyncTest : BaseTest<ProductSizeController>
    {
        [TestMethod]
        public async Task UpdateAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<IProductSizeBll, ProductSizeDto, ProductSizeDto>(autoMock, m => m.UpdateAsync(It.IsAny<ProductSizeDto>()), responseBll, param =>
                {
        ...
        public async Task UpdateAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<IProductSizeBll, ProductSizeDto>(autoMock, m => m.UpdateAsync(It.IsAny<ProductSizeDto>()), exception);
