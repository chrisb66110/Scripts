    ...
    public class GetByIdAsyncTest : BaseTest<ProductController>
    {
        ...
        public async Task GetByIdAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<IProductBll, string, ProductDto>(autoMock, m => m.GetByIdAsync(It.IsAny<string>()), responseBll, param =>
                {
        ...
        public async Task GetByIdAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict())
            {
                ...
                AndIMockDependencyMethod<IProductBll, ProductDto>(autoMock, m => m.GetByIdAsync(It.IsAny<string>()), exception);
