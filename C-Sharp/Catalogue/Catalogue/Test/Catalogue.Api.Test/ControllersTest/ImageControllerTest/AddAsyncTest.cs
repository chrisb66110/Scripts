...
namespace Catalogue.Api.Test.ControllersTest.ImageControllerTest
{
    ...
    [TestClass]
    public class AddAsyncTest : BaseTest<ImageController>
    {
        [TestMethod]
        public async Task AddAsyncHappyPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<IImageBll, ImageDto, ImageDto>(autoMock, m => m.AddAsync(It.IsAny<ImageDto>()), responseBll, param =>
                {
        ...
        public async Task AddAsyncErrorPath()
        {
            using (var autoMock = AutoMock.GetStrict(RegisterBasicDependency))
            {
                ...
                AndIMockDependencyMethod<IImageBll, ImageDto>(autoMock, m => m.AddAsync(It.IsAny<ImageDto>()), exception);
